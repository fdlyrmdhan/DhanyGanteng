...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/74fd634010128be37972c.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6283180593638 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : \n⭔ Saweria : ` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Script : https://github.com/fdlyrmdhan/rrq\n\n BAGI DUIT KLO GA DHANY NANGIS\n\nDonate : 6283180593638 (gopay,dana,pulsa)\nSaweria : https://saweria.co/dhany\nPaypal : https://www.paypal.me/dhany\n\n KLO GA DHANY NANGIS')
            }
            break
            case 'chat': {
...
break
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://github.com/fdlyrmdhan/rrq'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 831-8059-3638'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Status Bot',
